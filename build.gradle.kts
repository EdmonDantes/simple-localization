...
publishing {
    ...
    publications {
        create<MavenPublication>("maven") {
            pom {
                name.set("Simple localization")
                description.set("Small library for easy localization of your application")
                url.set("https://github.com/EdmonDantes/simple-localization")
                developers {
                    developer {
                ...
                scm {
                    connection.set("scm:git:git://github.com/EdmonDantes/simple-localization.git")
                    developerConnection.set("scm:git:ssh://github.com:EdmonDantes/simple-localization.git")
                    url.set("https://github.com/EdmonDantes/simple-localization/tree/master")
                }
            }
